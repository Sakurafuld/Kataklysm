package com.sakurafuld.kataklysm.api.touch;
...
//        if((player = pContext.getPlayer()) == null) return InteractionResult.FAIL;
...
//                    touch.turn(player, level);
//                    player.getInventory().removeItemNoUpdate(touch.getSlot());
//                    return InteractionResult.FAIL;
//                }
//
//                return touchable.onTouchBlock(player, pos, pContext.getClickedFace());
//            } else player.getInventory().removeItemNoUpdate(touch.getSlot());
//        }
//
//        return InteractionResult.FAIL;
//    }
