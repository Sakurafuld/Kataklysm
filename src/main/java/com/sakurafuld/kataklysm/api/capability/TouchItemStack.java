package com.sakurafuld.kataklysm.api.capability;

import com.sakurafuld.kataklysm.api.touch.ITouchable;
import com.sakurafuld.kataklysm.api.touch.TouchItem;
...
import static com.sakurafuld.kataklysm.Deets.identifier;

@Mod.EventBusSubscriber(modid = KATAKLYSM, bus = Mod.EventBusSubscriber.Bus.MOD)
public class TouchItemStack {
    ...
    public static class Provider implements ICapabilitySerializable<CompoundTag> {
        ...
        public static void attach(AttachCapabilitiesEvent<ItemStack> event) {
            ...
            event.addCapability(identifier(KATAKLYSM, "touch"), new Provider());
