...
import com.sakurafuld.kataklysm.content.ModMenus;
...
public class AnchorMenu extends AbstractContainerMenu {
    ...
    public void removed(Player player) {
        if(this.level != null && !this.level.isClientSide){
            ...
            PacketHandler.INSTANCE.send(PacketDistributor.PLAYER.with(()-> (ServerPlayer) player), new ClientboundAnchorUpdate(this.pos, this.slots.get(0).getItem().copy()));
